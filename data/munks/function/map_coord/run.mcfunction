...
execute at @s unless dimension minecraft:overworld run return run tellraw @s {translate:"function.munks.map_coord.error",fallback:"map_coord: 현재 차원에서는 작동하지 않습니다."}
