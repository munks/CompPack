...
tellraw @s [{text:"pos_message",color:yellow}, {text:": 들고 있는 아이템이 없을 때 Ctrl+Shift 입력 시 현재 위치를 채팅창에 띄웁니다.",color:white}]
...
tellraw @s [{text:"enchant_change",color:yellow}, {text:": 마법 부여가 변경됩니다.\n",color:white}, \
