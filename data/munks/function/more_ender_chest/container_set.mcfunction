...
execute if items entity @s player.cursor barrier[custom_data={left:true}] run scoreboard players set @s munks.var 1
execute if items entity @s player.cursor barrier[custom_data={right:true}] run scoreboard players set @s munks.var 2
